...
```s
bash <(curl -Ls [https://raw.githubusercontent.com/frankiejun/serv00-play/main/start.sh](https://raw.githubusercontent.com/Hyy800/serv00-play/refs/heads/main/start.sh))
```
